...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="ng-cloak" style="margin:20px;" ng-app="HomepageApp" ng-controller="HomepageController as mainCtrl" ng-init="init()" ng-cloak="">
                <div class="well" ng-repeat="blog in blogs">
                    ...
                    <div class="well" ng-repeat="story in blog.stories">
                        ...
                        <div>
                            <button type="button" class="btn btn-flat btn-default btn-xs" ng-click="story.comments.loadPrevPage()" ng-disabled="!story.comments.hasLessPages()"><i
                    ...
                    <div>
                        <button type="button" class="btn btn-flat btn-default btn-xs" ng-click="blog.stories.loadPrevPage()" ng-disabled="!blog.stories.hasLessPages()"><i class="fa fa-angle-left"></i>
                            Back
                        </button>
                        <button type="button" class="btn btn-flat btn-default btn-xs" ng-click="blog.stories.loadNextPage()" ng-disabled="!blog.stories.hasMorePages()">Next <i
